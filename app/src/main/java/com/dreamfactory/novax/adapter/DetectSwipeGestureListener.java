...
import com.dreamfactory.novax.activity.OrderDetailsActivity;
...
public class DetectSwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
    ...
    private OrderDetailsActivity activity = null;

    public OrderDetailsActivity getActivity() {
        return activity;
    }

    public void setActivity(OrderDetailsActivity activity) {
